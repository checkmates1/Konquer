...
ActiveRecord::Schema.define(version: 20161217174253) do
  ...
  add_index "pieces", ["y_position", "x_position"], name: "index_pieces_on_y_position_and_x_position", unique: true, using: :btree
